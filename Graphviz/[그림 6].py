...
station6_1 = ['Ilgwang', 'Gijang', 'OSIRIA', 'Songjeong', 'Sinhaeundae', 'BEXCO',
             'Centum', 'Jaesong', 'Busan Wondong', 'Allak', 'Dongnae', 'Busan National Univ. Edu',
             'Geoje', 'Geojehaemaji', 'Bujeon']
...
for i in range(num6_1station) :
    g1.node(station6_1[i], shape = 'square', color = 'darkblue')
...
for i in range(num6_1station-1) :
    g1.edge(station6_1[i], station6_1[i+1])
...
g1.node('Busan National Univ. Edu', shape = 'square', color = 'red')
g1.node('BEXCO', shape = 'square', color = 'red')
g1.node('Geoje', shape = 'square', color = 'red')
